...
Controlling for $x$ both worsens bias and efficiency. The reason for this is straightforward. In a regression model where $y$ is regressed on both $z$ and $z$
